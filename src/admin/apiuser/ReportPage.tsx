  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-4 gap-4">
        <SummaryCard title="Total Transactions" value="8" />

        <SummaryCard title="Total Amount" value="₹ 20,360.00" />
        ...
        <SummaryCard title="Total Surcharge" value="₹ 40.00" />
      </div>
      ...
      <div className="flex gap-4 flex-wrap">
        ...
        <select
          ...
          onChange={(e) =>
            setStatusFilter(
              e.target.value as "All" | StatusType
            )
          }
        ...
        <select
          ...
          onChange={(e) =>
            setModeFilter(
              e.target.value as "All" | ModeType
            )
          }
          className="border rounded-lg px-4 py-2 bg-white text-sm"
        >
...
function Badge({
  ...
  return (
    <span
      className={`px-2 py-1 rounded text-xs ${colors[color]}`}
    >
      {children}
    </span>
  );
