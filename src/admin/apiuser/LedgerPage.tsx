...
export default function LedgerPage() {
    ...
    const filteredLedger =
        typeFilter === "All"
            ? ledger
            : ledger.filter(item => item.type === typeFilter);
                ...
                <table className="w-full text-sm">
                    ...
                    <thead className="bg-gray-50 text-gray-600">
                        ...
                        <tr>
                            ...
                            <th className="px-5 py-3 text-left">Balance After</th>

                            <th className="px-5 py-3 text-left">Description</th>

                            <th className="px-5 py-3 text-left">Reference Type</th>

                            <th className="px-5 py-3 text-left">Reference ID</th>
                        ...
                        {filteredLedger.map((item, i) => (
                            ...
                            >
                                ...
                                <td className="px-5 py-4">
                                    ...
                                    <ReferenceBadge text={item.referenceType} />
...
function ReferenceBadge({ text }: any) {
